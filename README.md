...
Once the container has been built, you can launch it once you have [fetched your `openrc.sh` file](https://docs.jetstream-cloud.org/ui/cli/auth/#about-openrcsh-files).
...
```
$ bash cluster_launcher.sh -n lrose-test314 -p 149.165.154.1 -o ~/openrc.sh
...
```sh
❯ (lrose-test314) ~ ➜ cd ~/jupyterhub-deploy-kubernetes-jetstream/kubernetes_magnum/
```
